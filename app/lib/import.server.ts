...
async function runImport(buffer: ArrayBuffer, filename: string, jobId: string) {
  ...
  for (let i = 2; i <= sheet.rowCount; i++) {
    ...
    if (offer1Code) {
      offers.push({
        ...
        pcn5: clean(get(row, "OFFER1PCN5")),
        description5: clean(get(row, "OFFER1MODELDESCRIPTION5")),
        modelService: clean(get(row, "OFFER1MODELSERVICE")),
        modelService2: clean(get(row, "OFFER1MODELSERVICE2")),
        modelService3: clean(get(row, "OFFER1MODELSERVICE3")),
        modelService4: clean(get(row, "OFFER1MODELSERVICE4")),
        modelService5: clean(get(row, "OFFER1MODELSERVICE5")),
        billingTaxDiscount60: toFloat(get(row, "OFFER1BILLINGPAYMENTTAX_60_DISCOUNTFIRSTYEAR")),
        billingTaxDiscount48: toFloat(get(row, "OFFER1BILLINGPAYMENTTAX_48_DISCOUNTFIRSTYEAR")),
        billingTaxDiscount36: toFloat(get(row, "OFFER1BILLINGPAYMENTTAX_36_DISCOUNTFIRSTYEAR")),
        billingTaxDiscount24: toFloat(get(row, "OFFER1BILLINGPAYMENTTAX_24_DISCOUNTFIRSTYEAR")),
    ...
    if (offer2Code) {
      offers.push({
        ...
        pcn5: clean(get(row, "OFFER2PCN5")),
        description5: clean(get(row, "OFFER2MODELDESCRIPTION5")),
        modelService: clean(get(row, "OFFER2MODELSERVICE")),
        modelService2: clean(get(row, "OFFER2MODELSERVICE2")),
        modelService3: clean(get(row, "OFFER2MODELSERVICE3")),
        modelService4: clean(get(row, "OFFER2MODELSERVICE4")),
        modelService5: clean(get(row, "OFFER2MODELSERVICE5")),
        billingTaxDiscount60: toFloat(get(row, "OFFER2BILLINGPAYMENTTAX_60_DISCOUNTFIRSTYEAR")),
        billingTaxDiscount48: toFloat(get(row, "OFFER2BILLINGPAYMENTTAX_48_DISCOUNTFIRSTYEAR")),
        billingTaxDiscount36: toFloat(get(row, "OFFER2BILLINGPAYMENTTAX_36_DISCOUNTFIRSTYEAR")),
        billingTaxDiscount24: toFloat(get(row, "OFFER2BILLINGPAYMENTTAX_24_DISCOUNTFIRSTYEAR")),
  ...
  // Archivage retiré V1 : géré uniquement via webhook Shopify customers/delete (à venir post-recette)
