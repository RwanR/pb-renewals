...
.pb-header-client { flex: 1; display: flex; align-items: center; justify-content: flex-end; gap: 8px; font-size: 13px; color: var(--pb-text-muted); text-transform: lowercase; min-width: 0; overflow: hidden; }\
